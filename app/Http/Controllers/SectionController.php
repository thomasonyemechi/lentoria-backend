...
class SectionController extends Controller
{
    ...
    public function getSectionsBySlug($slug)
    {
        ...
        $section = Section::query()->where('course_id', $cid)->with('lectures:id,description,image,main_content,duration,section_id,title')->withCount('lectures')->orderBy('order', 'ASC')->get();
        return response(['data' => $section], 200);
    }
